    ...
    function initAddressAutocomplete(options) {
        ...
        const selector = options.selector || '.adresse-autocomplete';
        const minLength = options.minLength || 3;
        const limit = options.limit || 5;
        const apiUrl = options.apiUrl || 'https://api-adresse.data.gouv.fr/search/';
        ...
        function displaySuggestions(data, field) {
            ...
            data.features.forEach((feature, index) => {
                ...
                suggestion.addEventListener('mouseover', function () {
                    this.style.backgroundColor = '#6e6b6b';
                });
